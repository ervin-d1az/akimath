...
- **Built and tested.** The brand layer and Aki's character sheet: tokens, wordmark, app
  ...
  press primitives (`PressableSurface`, `BrandButton`, `IconButtonTile`) and the dashed
  outline. 232 Flutter tests, green.
...
6 files; `features/*/policy/` and `content/model/` are declared roots with nothing in them yet,
